#!/usr/bin/env python3
"""P3 independent aggregator: bindings, NRD/AURD, paired statistics.
...
def sign_flip_p(diffs):
    """Exact one-sided sign-flip p over 2^n assignments (n<=18)."""
    n = len(diffs)
    obs = sum(diffs) / n
    count = 0
