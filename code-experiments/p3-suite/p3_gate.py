#!/usr/bin/env python3
"""P3 one-shot promotion gate. Recomputes the ten frozen criteria from the raw
...
import p3_aggregate as AGG  # noqa: E402
...
def main() -> int:
    ...
    criteria = {
        "g1_campaigns_complete": len(campaigns) == 18
    ...
    gate = {
        "kind": "lineageguard_p3_gate_result_v1",
        ...
        "decision": decision,
        "one_shot": True,
        "notes": ("confirmatory-replication decision under protocol "
