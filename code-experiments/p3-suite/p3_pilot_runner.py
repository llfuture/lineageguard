#!/usr/bin/env python3
"""P3 fresh paired runner (confirmatory replication) (VALIDATION snapshot).
...
KIND = "lineageguard_p3_pilot_measurement_v1"
...
def main() -> int:
    ...
    print(f"[{_utc()}] P3 runner: {len(campaigns)} campaigns x "
    ...
    payload = {
        ...
        "scope": {"study_phase": "confirmatory_replication", "data_role": "validation_fresh",
    ...
    out = args.run_dir / "p3-measurement.json"
